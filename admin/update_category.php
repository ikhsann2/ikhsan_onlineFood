...
<body class="fix-header">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper" style="height:1200px;">
                ...
                <!-- Start Page Content -->
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Update Produk Category</h4>
                            </div>
                            <div class="card-body">
            ...
            <!-- End Container fluid  -->
            <!-- footer -->
            <footer class="footer"> All rights reserved. designed by <a href="https://instagram/ikhsn_lkl.com">Ikhsn_lkl </footer>
            <!-- End footer -->
        </div>
        <!-- End Page wrapper  -->
    </div>
