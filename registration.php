         ...
         <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-light">
               <div class="container">
                  ...
                  <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/logo3.jpeg" width="100px" alt=""> </a>
                        ...
                        <div class="widget">
                           <div class="widget-body">   
							  <form action="" method="post">
                                 <div class="row">
								  <div class="form-group col-sm-12 ">
                                    ...
                                    <div class="form-group col-sm-6">
									 ...
									 <div class="form-group col-sm-12">
                                       <label for="exampleTextarea">Alamat Pengantaran</label>
                                 ...
                                 <div class="row">
                                    <div class="col-sm-4">
                                       <p> <input type="submit" value="Mendaftar" name="submit" class="btn theme-btn"> </p>
                                    </div>
                                 </div>
                              </form>
