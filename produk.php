...
<body>
        ...
        <div class="page-wrapper">
            ...
            <div class="inner-page-hero bg-image" data-image-src="images/img/slider.jpg">
									      ...
									      while($rows=mysqli_fetch_array($ress))
										  {
													 ...
													 echo' <div class="col-sm-12 col-md-12 col-lg-8 text-xs-center text-sm-left">
															<div class="entry-logo">
																<a class="img-fluid" href="menu.php?res_id='.$rows['rs_id'].'" > <img src="admin/Res_img/'.$rows['image'].'" alt="Food logo"></a>
															</div>
															<!-- end:Logo -->
															<div class="entry-dscr">
																<h5><a href="menu.php?res_id='.$rows['rs_id'].'" >'.$rows['title'].'</a></h5> 
														 ...
														 <div class="col-sm-12 col-md-12 col-lg-4 text-xs-center">
																<div class="right-content bg-white">
																	...
																	<a href="menu.php?res_id='.$rows['rs_id'].'" class="btn theme-btn-dash">Lihat Menu</a> </div>
																</div>
																<!-- end:right info -->
															</div>';
										  }
