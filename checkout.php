...
<head>
    ...
    <link rel="icon" href="#">
    <title>Bonny | Online food terpercya</title>
    <!-- Bootstrap core CSS -->
        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-light">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.html"> <img class="img-rounded" src="images/logo3.png" width="100px" alt=""> </a>
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
						...
						if(empty($_SESSION["user_id"]))
						...
						else
							{
										...
										echo  '<li class="nav-item"><a href="your_orders.php" class="nav-link active">Pesanan Kamu</a> </li>';
