        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-light">
                <div class="container">
                    ...
                    <a class="navbar-brand p-0" href="index.html"> <img class="img-rounded" src="images/logo3.jpeg" width="100px" alt=""> </a>
        ...
        <div class="page-wrapper">
			...
			<?php $ress= mysqli_query($db,"select * from restaurant where rs_id='$_GET[res_id]'");
									     $rows=mysqli_fetch_array($ress);
										  ...
										  ?>
            <section class="inner-page-hero bg-image" data-image-src="images/img/slider.jpg">
                <div class="profile">
                    <div class="container">
                        <div class="row">
...
?>									
                                        ...
                                        <div class="title-row">
										<?php echo $item["title"]; ?><a href="menu.php?res_id=<?php echo $_GET['res_id']; ?>&action=remove&id=<?php echo $item["d_id"]; ?>" >
...
?>								  
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-6">
                        ...
                        <div class="menu-widget" id="2">
                            <div class="widget-heading">
                                <h3 class="widget-title text-dark">
                              PESAN MENU PUPULER KAMI SEKARANG! <a class="btn btn-link pull-right" data-toggle="collapse" href="#popular2" aria-expanded="true">
                                ...
                                <div class="food-item">
                                    <div class="row">
										...
										<span class="price pull-left" >Rp.<?php echo $product['price']; ?></span>
										  <input class="b-r-0" type="text" name="quantity"  style="marn-left:30gipx;" value="1" size="2" />
										  <input type="submit" class="btn theme-btn" style="margin-left:40px;" value="Add To Chart" />
										</div>
										</form>
                                    </div>
                                    <!-- end:row -->
